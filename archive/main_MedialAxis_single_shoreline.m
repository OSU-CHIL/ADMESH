...
%==========================================================================
i = 8;
XY_b = [Shoreline(i).X; Shoreline(i).Y]';
...
id_MA = Skeletonization_DivSSED_v2(X,Y,Vx,Vy);
id_MA(id_out) = 0;
...
% Pruning corners
%==========================================================================
MA_pruned = SkeletonPruning_Choi_level1branch(X,Y,Vx,Vy,D,MA_merged,rho_pruning,dtheta);
